= Contributing to Avro Dynamic Records

Avro Dynamic Records is released under the Apache 2.0 license. If you would like to contribute something, or want to hack on the code this document should help you get started.
...
If you think you have found a security vulnerability in Avro Dynamic Records please *DO NOT* disclose it publicly until we've had a chance to fix it.
