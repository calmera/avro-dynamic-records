...
import com.github.calmera.dyre.encoders.ValueEncoder;
...
public class DynamicRecords {
	...
	public <T extends DynamicRecord> T newRecord(Class<T> cls, Map<String, Object> initialValues) {
		DyreRecord subAnno = cls.getDeclaredAnnotation(DyreRecord.class);
		if (subAnno != null) {
		...
		throw new IllegalArgumentException(
				"Can't decide where to get the schema from: no DyreRecord annotation has been found.");
	}
