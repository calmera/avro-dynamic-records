...
package com.github.calmera.serde.map;
...
import com.github.calmera.dyre.DyreUtils;
import com.github.calmera.dyre.ValueMappingException;
import com.github.calmera.dyre.decoders.ValueDecoder;
import com.github.calmera.serde.map.models.EnumModel;
import com.github.calmera.serde.map.models.ListModel;
import com.github.calmera.serde.map.models.MapModel;
import com.github.calmera.serde.map.models.Person;
import com.github.calmera.serde.map.models.State;
...
class ValueDecoderTest {
	...
	void encodeAvroUtf8ListToStringList() throws ValueMappingException {
		...
		Object result = ValueDecoder.DEFAULT_DECODER.decode(new StringListType(), arrUtf8,
				new Annotation[] { DyreUtils.dyreField(String.class, false) });
